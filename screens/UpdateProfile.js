...
export default class UpdateProfile extends Component {
  ...
  handleSubmit = () => {
    ...
    if (this.state.usernameChanged) obj.userName = this.state.username;
    ...
    if (this.state.uStateChanged) obj.state = this.state.uState;
    if (this.state.uCityChanged) obj.city = this.state.uCity;
    obj.bankDetails = {};
